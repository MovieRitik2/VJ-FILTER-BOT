...
BOT_TOKEN = environ.get('BOT_TOKEN', "7779430218:AAHSbztscgkY4jPJttL33evySlSMCBT_5s0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002499622653'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6085202935').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb srv://ritikjatain116:GfVgQPTAQHHbybfeeclusterů.az6w.mongodb.net//retryWrites truela majority&appName Clusterü")
